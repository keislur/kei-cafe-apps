 ...
 * @author KeimalST
 */
public class Percobaan_USER extends javax.swing.JFrame {
    ...
    class usser extends Percobaan_USER{
        int id, id_level;
        ...
        public usser(){
            ...
            id_level = Integer.parseInt(cboxLevel.getSelectedItem().toString());
        }
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            usser u = new usser();
            this.stat = k.getCon().prepareStatement("update user set username=?, password=?, nama_user=?, id_level=? where id=?");
            stat.setString(1, u.username);
            stat.setString(2, u.password);
            stat.setString(3, u.nama);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
            usser u = new usser();
            this.stat = k.getCon().prepareStatement("delete from user where id=?");
            stat.setInt(1, u.id);
            stat.executeUpdate();
        } catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Percobaan_USER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Percobaan_USER().setVisible(true);
            }
        });
    }
