...
public class Order extends javax.swing.JFrame {
    ...
    private void tampildata() {
        ...
        try{
            Koneksi();
            String sql = "Select * from order1 order by id asc";
    ...
    private void IdAuto() {
        try{
            Koneksi();
            String sql = "select max(right(id,1)) as no from order1";
            ResultSet rs = cn.executeQuery(sql);
            while(rs.next()){
                if(rs.first() == false){
                    txtId.setText("1");
    ...
    private void to_details(){
        DetailOrder dos = new DetailOrder();
        dos.setVisible(true);
        this.setVisible(false);
        dos.txtOrder.setEnabled(false);
        dos.txtChart.setEnabled(false);
        dos.txtHarga.setEnabled(false);
    ...
    private void initComponents() {
        ...
        cboxStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Status!", "Makan di tempat", "Bawa Pulang" }));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(25, 25, 25)
                        .addComponent(txtMeja, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
            Koneksi();
            String sql = "delete from order1 where id='"+txtId.getText()+"'";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            ...
            String sql = "update order1 set no_meja='"
                    +txtMeja.getText()
                    +"',"
                    +"tanggal='"
                    +tanggal
    ...
    int table = jTable1.getSelectedRow();
        ...
        try {
            ...
            Date tanggalDate1 = dateFormat.parse(c);
            DateTgl.setDate(tanggalDate1);
        } catch (ParseException ex) {
            ex.printStackTrace();
        }
        cboxUser.setSelectedItem(d);
        txtKet.setText(e);
    ...
    private void btnInsert1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert1ActionPerformed
        ...
        try{
            ...
            bersih();
            to_details();
            JOptionPane.showMessageDialog(null, "Lanjut ke Detail Order untuk konfirmasi pembayaran..");
        }catch(SQLException | HeadlessException e){
            JOptionPane.showMessageDialog(null, "Proses update gagal/koneksi gagal...");
            System.out.println(e.getMessage());
        }
